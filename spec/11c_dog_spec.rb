...
describe Dog do
  ...
  subject(:mr_peanutbutter) { described_class.new("Mr. Peanutbutter", "Golden Retriever", "Golden") }
  ...
  it 'is not barking' do
    expect(mr_peanutbutter).not_to be_barking
  end

  # remove the 'x' before running this test
  it 'is sleeping' do
    expect(mr_peanutbutter).to be_sleeping
  end
end
